...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	tskr2: { // reskin of [TAKE HEART] <UNUSED>
		num: 370,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	sakurastrike: { // reskin of [LEAF STORM] but better
		num: 370,
		accuracy: 100,
		basePower: 100,
		category: "Special",
	...
	kurokamistrike: { // exclusive to event special
		num: 370,
		accuracy: 90,
		basePower: 120,
		category: "Physical",
	...
	fubuzillabeam: { // exclusive to event special
		num: 76,
		accuracy: 90,
		basePower: 120,
		category: "Special",
	...
	splitpersonality: { // flying press but with dark/fairy
		num: 370,
		accuracy: 100,
		basePower: 50,
		category: "Physical",
	...
	dualwielding: { // dual wingbeat but fighting
		num: 370,
		accuracy: 75,
		basePower: 75,
		category: "Physical",
	...
	duckdance: { // dragon dance reskin
		...
		pp: 20,
		priority: 0,
		flags: {snatch: 1, dance: 1, gravity: 1},
		boosts: {
			atk: 1,
			spe: 1,
		},
	...
	oozorapolice: { // circle throw but better
		num: 370,
		accuracy: 90,
		basePower: 90,
		category: "Physical",
		...
		pp: 10,
		priority: -6,
		flags: {contact: 1, protect: 1, mirror: 1, noassist: 1, failcopycat: 1, punch: 1},
		forceSwitch: true,
		target: "normal",
		type: "Fighting",
		contestType: "Cool",
	...
	tarots: { // bullet seed but psychic
		num: 370,
		accuracy: 100,
		basePower: 30,
		category: "Physical",
	...
	painpeko: { // dank type close combat
		num: 370,
		accuracy: 90,
		basePower: 120,
		category: "Physical",
	...
	necromancy: { // revival blessing but ghost
		num: 370,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	succubusstrike: { // made with Contray in mind
		num: 370,
		accuracy: 90,
		basePower: 110,
		category: "Physical",
	...
	paintbrush: { // this move replaces the target's ability with Colour Change
		num: 370,
		accuracy: 100,
		basePower: 100,
		category: "Physical",
	...
	nopressure: { // parting shot but for defense stats
		num: 370,
		accuracy: 100,
		basePower: 0,
		category: "Status",
	...
	tentacles: { // bullet seed but squib
		num: 370,
		accuracy: 80,
		basePower: 15,
		category: "Physical",
	...
	supernova: { // double-edge but Psychic
		num: 38,
		accuracy: 90,
		basePower: 130,
		category: "Special",
	...
	bigbang: { // EXPLOSION but is is Psychic type
		num: 153,
		accuracy: true,
		basePower: 250,
		category: "Physical",
	...
	timeflies: { // extreme speed but psychic (and weaker)
		num: 370,
		accuracy: 100,
		basePower: 50,
		onBasePower(basePower) {
	...
	courtchange: {
		...
		onHitField(target, source) {
			const sideConditions = [
				'mist', 'lightscreen', 'reflect', 'spikes', 'hologram', 'carrottrap', 'safeguard', 'tailwind', 'toxicspikes', 'stealthrock', 'waterpledge', 'firepledge', 'grasspledge', 'stickyweb', 'auroraveil', 'luckychant', 'gmaxsteelsurge', 'gmaxcannonade', 'gmaxvinelash', 'gmaxwildfire', 'gmaxvolcalith',
			];
			let success = false;
	...
	defog: {
		...
		onHit(target, source, move) {
			...
			const removeTarget = [
				'reflect', 'lightscreen', 'carrottrap', 'auroraveil', 'safeguard', 'hologram', 'mist', 'spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'gmaxsteelsurge',
			];
			const removeAll = [
				'spikes', 'toxicspikes', 'stealthrock', 'carrottrap', 'stickyweb', 'gmaxsteelsurge',
			];
