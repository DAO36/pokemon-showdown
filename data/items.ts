export const Items: import('../sim/dex-items').ItemDataTable = {
	...
	matsurite: {
		name: "Matsurite",
		spritenum: 586,
		megaStone: {"Matsuri": "Matsuri-Mega"},
		itemUser: ["Matsuri"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	haachamite: {
		name: "Haachamite",
		spritenum: 628,
		megaStone: {"Haachama": "Haachama-Mega"},
		itemUser: ["Haachama"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	akirosite: {
		name: "Akirosite",
		spritenum: 619,
		megaStone: {"Akirose": "Akirose-Mega"},
		itemUser: ["Akirose"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	callite: {
		name: "Callite",
		spritenum: 584,
		megaStone: {"Calliope": "Calliope-Mega"},
		itemUser: ["Calliope"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	nerissite: {
		name: "Nerissite",
		spritenum: 623,
		megaStone: {"Nerissa": "Nerissa-Mega"},
		itemUser: ["Nerissa"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	elizalite: {
		name: "Elizalite",
		spritenum: 586,
		megaStone: {"Elizabeth": "Elizabeth-Mega"},
		itemUser: ["Elizabeth"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	cecilite: {
		name: "Cecilite",
		spritenum: 616,
		megaStone: {"Cecilia": "Cecilia-Mega"},
		itemUser: ["Cecilia"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	aerodactylitez: {
		...
		spritenum: 577,
		megaStone: { "Aerodactyl": "Aerodactyl-Mega-Z" },
		itemUser: ["Aerodactyl"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	alakazitez: {
		name: "Alakazite Z",
		spritenum: 579,
		megaStone: { "Alakazam": "Alakazam-Mega-Z" },
		itemUser: ["Alakazam"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	araquanite:  {
        name: "Araquanite",
        spritenum: 588,
        megaStone: { "Araquanid": "Araquanid-Mega" },
        itemUser: ["Araquanid"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	azumarillite: {
		name: "Azumarillite",
		spritenum: 617,
		megaStone: { "Azumarill": "Azumarill-Mega" },
		itemUser: ["Azumarill"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	blacephalite:  {
        name: "Blacephalite",
        spritenum: 588,
        megaStone: { "Blacephalon": "Blacephalon-Mega" },
        itemUser: ["Blacephalon"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
        num: 656,
	...
	blissite: {
		name: "Blissite",
		spritenum: 584,
		megaStone: {"Blissey": "Blissey-Mega"},
		itemUser: ["Blissey"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	buzzwolite:  {
        name: "Buzzwolite",
        spritenum: 588,
        megaStone: { "Buzzwole": "Buzzwole-Mega" },
        itemUser: ["Buzzwole"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	celesteelite: {
		name: "Celesteelite",
		spritenum: 625,
		megaStone: { "Celesteela": "Celesteela-Mega" },
		itemUser: ["Celesteela"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	cloysterite: {
		name: "Cloysterite",
		spritenum: 544,
		megaStone: { "Cloyster": "Cloyster-Mega" },
		itemUser: ["Cloyster"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	eelektrossitez: {
		...
		spritenum: 556,
		megaStone: { "Eelektross": "Eelektross-Mega-Z" },
		itemUser: ["Eelektross"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	empoleonitex: {
		name: "Empoleonite X",
		spritenum: 552,
		megaStone: { "Empoleon": "Empoleon-Mega-X" },
		itemUser: ["Empoleon"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	empoleonitey: {
		name: "Empoleonite Y",
		spritenum: 552,
		megaStone: { "Empoleon": "Empoleon-Mega-Y" },
		itemUser: ["Empoleon"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	empoleonitez: {
		name: "Empoleonite Z",
		spritenum: 552,
		megaStone: { "Empoleon": "Empoleon-Mega-Z" },
		itemUser: ["Empoleon"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	exploudite: {
		name: "Exploudite",
		spritenum: 575,
		megaStone: {"Exploud": "Exploud-Mega"},
		itemUser: ["Exploud"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	gliscorite: {
		name: "Gliscorite",
		spritenum: 512,
		megaStone: { "Gliscor": "Gliscor-Mega" },
		itemUser: ["Gliscor"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	goldlite: {
		name: "Goldlite",
		spritenum: 583,
		megaStone: { "Golduck": "Golduck-Mega" },
		itemUser: ["Golduck"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	guzzlordite: {
		name: "Guzzlordite",
		spritenum: 589,
		megaStone: { "Guzzlord": "Guzzlord-Mega" },
		itemUser: ["Guzzlord"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	gyaradositex: {
		name: "Gyaradosite X",
		spritenum: 589,
		megaStone: { "Gyarados": "Gyarados-Mega-X" },
		itemUser: ["Gyarados"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	gyaradositey: {
		name: "Gyaradosite Y",
		spritenum: 589,
		megaStone: { "Gyarados": "Gyarados-Mega-Y" },
		itemUser: ["Gyarados"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	jellicite:  {
        name: "Jellicite",
        spritenum: 588,
        megaStone: { "Jellicent": "Jellicent-Mega" },
        itemUser: ["Jellicent"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	kabutopsite: {
		name: "Kabutopsite",
		spritenum: 592,
		megaStone: { "Kabutops": "Kabutops-Mega" },
		itemUser: ["Kabutops"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	kartanite:  {
        name: "Kartanite",
        spritenum: 588,
        megaStone: { "Kartana": "Kartana-Mega" },
        itemUser: ["Kartana"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	lightball: {
		...
		onModifyAtkPriority: 1,
		onModifyAtk(atk, pokemon) {
			if (pokemon.baseSpecies.baseSpecies === 'Pikachu' || "Ash\u2019s Pikachu") {
				return this.chainModify(2);
			}
		},
		onModifySpAPriority: 1,
		...
		itemUser: ["Pikachu", "Pikachu-Cosplay", "Pikachu-Rock-Star", "Pikachu-Belle", "Pikachu-Pop-Star", "Pikachu-PhD", "Pikachu-Libre", "Pikachu-Original", "Pikachu-Hoenn", "Pikachu-Sinnoh", "Pikachu-Unova", "Pikachu-Kalos", "Pikachu-Alola", "Pikachu-Partner", "Pikachu-Starter", "Pikachu-World", "Ash\u2019s Pikachu", "Ash-Pikachu"],
		num: 236,
		gen: 2,
	},
	lightclay: {
	...
	lilligantite:  {
        name: "Lilligantite",
        spritenum: 588,
        megaStone: { "Lilligantite": "Lilligantite-Mega" },
        itemUser: ["Lilligantite"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
        num: 656,
	...
	lurantisite:  {
        name: "Lurantisite",
        spritenum: 588,
        megaStone: { "Lurantis": "Lurantis-Mega" },
        itemUser: ["Lurantis"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	mamoswinite: {
		name: "Mamoswinite",
		spritenum: 563,
		megaStone: { "Mamoswine": "Mamoswine-Mega" },
		itemUser: ["Mamoswine"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	maractite:  {
        name: "Maractite",
        spritenum: 588,
        megaStone: { "Maractus": "Maractus-Mega" },
        itemUser: ["Maractus"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	mewtwonitez: {
		name: "Mewtwonite Z",
		spritenum: 601,
		megaStone: { "Mewtwo": "Mewtwo-Mega-Z" },
		itemUser: ["Mewtwo"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	mewtwonitea: {
		name: "Mewtwonite A",
		spritenum: 601,
		megaStone: { "Mewtwo": "Mewtwo-Mega-A" },
		itemUser: ["Mewtwo"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	mewtwoniteb: {
		name: "Mewtwonite B",
		spritenum: 601,
		megaStone: { "Mewtwo": "Mewtwo-Mega-B" },
		itemUser: ["Mewtwo"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	mismagiusite:  {
        name: "Mismagiusite",
        spritenum: 588,
        megaStone: { "Mismagius": "Mismagius-Mega" },
        itemUser: ["Mismagius"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	naganadelite:  {
        name: "Naganadelite",
        spritenum: 588,
        megaStone: { "Naganadel": "Naganadel-Mega" },
        itemUser: ["Naganadel"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	nihilegolite:  {
        name: "Nihilegolite",
        spritenum: 588,
        megaStone: { "Nihilego": "Nihilego-Mega" },
        itemUser: ["Nihilego"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	palossandite:  {
        name: "Palossandite",
        spritenum: 588,
        megaStone: { "Palossand": "Palossand-Mega" },
        itemUser: ["Palossand"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	pheromosite:  {
        name: "Pheromosite",
        spritenum: 588,
        megaStone: { "Pheromosa": "Pheromosa-Mega" },
        itemUser: ["Pheromosa"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	rampardosite: {
		name: "Rampardosite",
		spritenum: 497,
		megaStone: { "Rampardos": "Rampardos-Mega-Y" },
		itemUser: ["Rampardos"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	rhyperiorite:  {
        name: "Rhyperiorite",
        spritenum: 588,
        megaStone: { "Rhyperior": "Rhyperior-Mega" },
        itemUser: ["Rhyperior"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	stakatakite: {
		name: "Stakatakite",
		spritenum: 500,
		megaStone: { "Stakataka": "Stakataka-Mega" },
		itemUser: ["Stakataka"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	swoobite: {
		name: "Swoobite",
		spritenum: 612,
		megaStone: { "Swoobat": "Swoobat-Mega" },
		itemUser: ["Swoobat"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	togekissite: {
		name: "Togekissite",
		spritenum: 589,
		megaStone: { "Togekiss": "Togekiss-Mega" },
		itemUser: ["Togekiss"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	toxapexite:  {
        name: "Toxapexite",
        spritenum: 588,
        megaStone: { "Toxapex": "Toxapex-Mega" },
        itemUser: ["Toxapex"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	tsareenite:  {
        name: "Tsareenite",
        spritenum: 588,
        megaStone: { "Tsareena": "Tsareena-Mega" },
        itemUser: ["Tsareena"],
        onTakeItem(item, source) {
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
	...
	wobbuffetite: {
		name: "Wobbuffetite",
		spritenum: 575,
		megaStone: {"Wobbuffet": "Wobbuffet-Mega"},
		itemUser: ["Wobbuffet"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	xurkitrite: {
		name: "Xurkitrite",
		spritenum: 575,
		megaStone: {"Xurkitree": "Xurkitree-Mega"},
		itemUser: ["Xurkitree"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
