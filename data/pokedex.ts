export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	aqua: {
		...
		types: ["Water", "Fairy"],
		gender: "F",
		baseStats: {hp: 70, atk: 115, def: 70, spa: 125, spd: 115, spe: 105},
	...
	aquamega: {
		...
		types: ["Water", "Fairy"],
		gender: "F",
		baseStats: {hp: 70, atk: 135, def: 80, spa: 145, spd: 155, spe: 115},
		abilities: {0: "Drizzle"},
		heightm: 1.48,
		weightkg: 55.5,
		color: "Blue",
	...
	lui: {
		...
		gender: "F",
		baseStats: {hp: 110, atk: 125, def: 100, spa: 110, spd: 80, spe: 75},
	...
	luimega: {
		...
		types: ["Flying", "Psychic"],
		gender: "F",
		baseStats: {hp: 110, atk: 145, def: 130, spa: 130, spd: 100, spe: 85},
