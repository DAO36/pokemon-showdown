export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	raden: {
		...
		gender: "F",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "White Smoke", 1: "Water Absorb", H: "Dancer", S: "Noh Mask"}, // uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuh
		heightm: 1.59,
		weightkg: 55.5,
		color: "Black",
		eggGroups: ["Human-Like"],
		otherFormes: ["Raden-Mega"],
		formeOrder: ["Raden", "Raden-Mega"],
	},
	radenmega: {
		num: 53,
		name: "Raden-Mega",
