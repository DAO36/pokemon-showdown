export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	ashspikachu: {
		...
		color: "Yellow",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Ash-Pikachu"],
		formeOrder: ["Ash\u2019s-Pikachu", "Ash-Pikachu"],
	},
	ashpikachu: {
		num: 26,
		name: "Ash-Pikachu",
	...
	ashslucario: {
		...
		gender: "M",
		baseStats: {hp: 70, atk: 110, def: 70, spa: 115, spd: 70, spe: 90},
		abilities: {0: "Aura Bond"},
		heightm: 1.2,
		weightkg: 54,
		color: "Blue",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Ash-Lucario"],
		formeOrder: ["Ash\u2019s-Lucario", "Ash-Lucario"],
	},
	ashlucario: {
		num: 448,
		name: "Ash-Lucario",
		baseSpecies: "Ash\u2019s Lucario",
		forme: "Ash",
		types: ["Fighting", "Steel"],
		gender: "M",
