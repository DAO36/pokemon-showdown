export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	polka: {
		...
		abilities: {0: "Hustle", 1: "Prankster", H: "Dancer", S: "The Legend of Polka"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like", "Field"],
	...
	koyori: {
		...
		abilities: {0: "Hustle", 1: "Technician", H: "Psychic Surge", S: "Mad Science"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like", "Field"],
	...
	chloe: {
		...
		abilities: {0: "Screen Cleaner", 1: "Water Veil", H: "Stench", S: "Cleaner"},
		heightm: 1.48,
		weightkg: 55.5,
		color: "Gray",
